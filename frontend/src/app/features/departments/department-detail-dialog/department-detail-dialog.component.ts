...
@Component({
  ...
  template: `
      ...
      <div class="detail-section">
        ...
        <div class="detail-grid">
          ...
          <div class="detail-item">
            ...
            <span class="value">{{ data.corporateName || 'Global' }}</span>
          </div>
          <div class="detail-item">
    ...
    <mat-dialog-actions align="end">
      <button mat-stroked-button matTooltip="Edit Department" color="primary" (click)="edit()">
  ...
  styles: [`
    ...
    .detail-item .value.link { color: #4527a0; }
...
export class DepartmentDetailDialogComponent {
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: Department,
    private dialogRef: MatDialogRef<DepartmentDetailDialogComponent>
  ) {}
