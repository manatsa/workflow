...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeSettings() {
        ...
        // General Settings
        createSettingIfNotExists("app.name", "Sonar Workflow System", "Application Name", "General", "General", Setting.SettingType.STRING);
        ...
        createSettingIfNotExists("mail.from.name", "Sonar Workflow", "From Name", "Sender Information", "Mail Settings", Setting.SettingType.STRING);
