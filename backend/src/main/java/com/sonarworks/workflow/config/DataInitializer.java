...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeSettings() {
        ...
        // Mail Settings
        createSettingIfNotExists("mail.from.address", "noreply@sonarworks.com", "From Email Address", "Mail", "Mail Settings", Setting.SettingType.EMAIL);
        createSettingIfNotExists("mail.from.name", "Sonarworks Workflow", "From Name", "Mail", "Mail Settings", Setting.SettingType.STRING);
        ...
        // Theme Settings
        createSettingIfNotExists("theme.primary.color", "#1976d2", "Primary Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.secondary.color", "#424242", "Secondary Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.accent.color", "#ff4081", "Accent Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.sidebar.bg", "#263238", "Sidebar Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.sidebar.text", "#ffffff", "Sidebar Text Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.sidebar.header.bg", "#1e272c", "Sidebar Header Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.sidebar.footer.bg", "#1e272c", "Sidebar Footer Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.header.bg", "#ffffff", "Main Header Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.header.text", "#333333", "Main Header Text Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.brand.color", "#1976d2", "Brand Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.user.profile.bg", "#1e272c", "User Profile Area Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.user.profile.text", "#ffffff", "User Profile Text Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.success.color", "#4caf50", "Success Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.warning.color", "#ff9800", "Warning Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.error.color", "#f44336", "Error Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.info.color", "#2196f3", "Info Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.body.bg", "#f5f5f5", "Body Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.card.bg", "#ffffff", "Card Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.border.color", "#e0e0e0", "Border Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.table.header.bg", "#f5f5f5", "Table Header Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.table.stripe.bg", "#fafafa", "Table Stripe Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.button.primary.bg", "#1976d2", "Primary Button Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.button.primary.text", "#ffffff", "Primary Button Text", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.button.secondary.bg", "#757575", "Secondary Button Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.button.secondary.text", "#ffffff", "Secondary Button Text", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.link.color", "#1976d2", "Link Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.link.hover.color", "#1565c0", "Link Hover Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.input.bg", "#ffffff", "Input Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.input.border", "#bdbdbd", "Input Border Color", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.input.focus.border", "#1976d2", "Input Focus Border", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.menu.active.bg", "#1976d2", "Menu Active Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.menu.hover.bg", "#37474f", "Menu Hover Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.badge.pending.bg", "#ff9800", "Pending Badge Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.badge.approved.bg", "#4caf50", "Approved Badge Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.badge.rejected.bg", "#f44336", "Rejected Badge Background", "Theme", "Theme Settings", Setting.SettingType.COLOR);
        createSettingIfNotExists("theme.font.primary", "Roboto, sans-serif", "Primary Font", "Theme", "Theme Settings", Setting.SettingType.STRING);
        createSettingIfNotExists("theme.font.size.base", "14", "Base Font Size (px)", "Theme", "Theme Settings", Setting.SettingType.NUMBER);
        createSettingIfNotExists("theme.dark.mode", "false", "Dark Mode Enabled", "Theme", "Theme Settings", Setting.SettingType.BOOLEAN);
