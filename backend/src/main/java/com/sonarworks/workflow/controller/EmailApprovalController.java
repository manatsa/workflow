...
public class EmailApprovalController {
    ...
    public ResponseEntity<ApiResponse<WorkflowInstanceDTO>> processApproval(
        ...
        if (principal instanceof com.sonarworks.workflow.security.CustomUserDetails) {
            authenticatedEmail = ((com.sonarworks.workflow.security.CustomUserDetails) principal).getEmail();
